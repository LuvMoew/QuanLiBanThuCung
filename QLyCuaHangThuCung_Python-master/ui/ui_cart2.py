...
"      ")
        ...
        self.lineEdit = QLineEdit(ShoppingCart)
...
"")
        ...
        self.couponLayout.addWidget(self.lineEdit)
...
"        ")
        ...
        self.deleteButton = QPushButton(ShoppingCart)
        self.deleteButton.setObjectName(u"deleteButton")
        self.deleteButton.setMinimumSize(QSize(133, 40))
...
"        ")
        ...
        self.couponLayout.addWidget(self.deleteButton)
...
"           ")
    ...
    def retranslateUi(self, ShoppingCart):
        ...
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("ShoppingCart", u"Nh\u1eadp s\u1ed1 l\u01b0\u1ee3ng..", None))
        self.updateCartButton.setText(QCoreApplication.translate("ShoppingCart", u"  C\u1eadp nh\u1eadt gi\u1ecf h\u00e0ng  ", None))
        self.deleteButton.setText(QCoreApplication.translate("ShoppingCart", u"X\u00f3a ", None))
