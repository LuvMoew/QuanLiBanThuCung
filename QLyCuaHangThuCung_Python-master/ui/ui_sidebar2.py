...
"}")
        ...
        self.user_icon = QPushButton(self.icon_only_widget)
        self.user_icon.setObjectName(u"user_icon")
        icon7 = QIcon()
        icon7.addFile(u":/Icons/bell-boy.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.user_icon.setIcon(icon7)
        self.user_icon.setCheckable(True)
        self.user_icon.setAutoExclusive(True)

        self.verticalLayout.addWidget(self.user_icon)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/Icons/right-from-bracket-solid.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"")
        ...
        self.user_name = QPushButton(self.icon_name_widget)
        self.user_name.setObjectName(u"user_name")
        self.user_name.setIcon(icon7)
        self.user_name.setCheckable(True)
        self.user_name.setAutoExclusive(True)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/Icons/bars-solid.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.horizontalSpacer_2 = QSpacerItem(198, 19, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
...
"")
        ...
        icon10 = QIcon()
        icon10.addFile(u":/Icons/loupe (1).png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.horizontalSpacer = QSpacerItem(198, 19, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_4.addItem(self.horizontalSpacer)

        self.cart_icon = QPushButton(self.header_widget)
        self.cart_icon.setObjectName(u"cart_icon")
        self.cart_icon.setStyleSheet(u"border: none;")
        icon11 = QIcon()
        icon11.addFile(u":/Icons/shopping-cart.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.cart_icon.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/Icons/user-solid.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.account_icon.setIcon(icon12)
...
"font-weight: bold;")
        ...
        self.label_9 = QLabel(self.pay_page)
        self.label_9.setObjectName(u"label_9")
        self.label_9.setGeometry(QRect(120, 120, 101, 61))
        font4 = QFont()
        ...
        self.user_icon.toggled.connect(self.user_name.setChecked)
        self.user_name.toggled.connect(self.user_icon.setChecked)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.user_name.setText(QCoreApplication.translate("MainWindow", u"Ng\u01b0\u1eddi d\u00f9ng", None))
        self.pushButton_10.setText(QCoreApplication.translate("MainWindow", u"\u0110\u0103ng xu\u1ea5t", None))
        self.menu.setText("")
        self.pushButton_14.setText("")
        self.cart_icon.setText("")
        ...
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"payyyyy", None))
